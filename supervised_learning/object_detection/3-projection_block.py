...
def projection_block(A_prev, filters, s=2):
    ...
    - filters: tuple or list containing [F11, F3, F12]
        ...
        * F12: number of filters in the second 1x1 convolution
               and the shortcut 1x1 convolution
    ...
    # Second component of main path (3x3 conv with stride 1)
    X = K.layers.Conv2D(
        filters=F3,
        kernel_size=(3, 3),
        strides=(1, 1),
    ...
    # Third component of main path (1x1 conv with stride 1)
    X = K.layers.Conv2D(
        filters=F12,
        kernel_size=(1, 1),
        strides=(1, 1),
    ...
    # Add main path and shortcut path outputs together, then apply ReLU
