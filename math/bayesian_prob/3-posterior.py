#!/usr/bin/env python3
"""Module for computing Bayesian Probability Posterior."""
import numpy as np
...
def posterior(x, n, P, Pr):
    ...
    # Marginal ehtimal (Intersection cəmi)
    marginal_prob = np.sum(intersection_values)

    # Posterior ehtimal (Intersection / Marginal)
    posterior_values = intersection_values / marginal_prob
